...
CONFIG = {
    ...
    "MODEL": {"MODEL_NAME": "seresnext50_32x4d", "FC_DIM": 512, "DROPOUT": 0.2},
    "NUM_CLASSES": 11014,
    "TRAINING": {
        "IMAGE_SIZE": 512,
        "BATCH_SIZE": 16,
    ...
    "PATH": {
        ...
        "SAVE_WEIGHT_PATH": "/content/drive/My Drive/Shopee - Price Match Guarantee/WEIGHTS/seresnext50_32x4d/1st_MAY_V1/"
